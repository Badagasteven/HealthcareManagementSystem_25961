          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="bg-gradient-to-r from-blue-600 via-yellow-400 to-green-600 text-white p-8">
              ...
              <p className="text-white/90 text-sm mt-1">
                Enter the reset code sent to your email + your new password.
              </p>
            </div>
            ...
            <form onSubmit={onSubmit} className="p-8 space-y-5">
              ...
              <div>
                ...
                <input className="mt-2 w-full border border-slate-200 rounded-xl px-4 py-3 bg-slate-50" value={email} readOnly />
              </div>

              <div>
                <label className="text-sm font-semibold text-slate-700">Reset Code</label>
                <input
                ...
                <p className="text-xs text-slate-500 mt-2">
                  If you don’t see it, check <b>Spam</b> or search for <b>Password Reset</b>.
                </p>
              </div>
              ...
              <div className="text-xs text-slate-500 border-t pt-4">
                Your password will be updated immediately after successful verification.
              </div>
            </form>
          </div>
        </div>
